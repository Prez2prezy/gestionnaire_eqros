...
# Ceci va afficher les vrais noms de colonnes de votre table "paroisses"
colonnes_reelles = c.execute("PRAGMA table_info(paroisses)").fetchall()
st.write("Vraies colonnes :", [col[1] for col in colonnes_reelles])
